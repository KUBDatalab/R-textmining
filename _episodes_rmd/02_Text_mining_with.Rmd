...
To analyze the speeches we need to make the text tidy. Tidy text refers to a dataset where each text has been split up into the individual words that make up the speech, and in format where each row contains one word. ![alt text](../fig/Tidy_text.png ”Tidy text example)

Splitting texts, in our case speeches, into individual words is called tokenization ![alt text](../fig/Tokenization.png ”Tokenization of example sentence)
...
## Stopwords
In all natural language texts, frequent words that carry little meaning by themselves are distributed all across the text ![alt text](../fig/Stopwords.png ”Stopwords examples)
...
![alt text](../fig/Venn_left_join.jpg ”left_join AFINN Index with tidy text)
...
![alt text](../fig/Venn_anti_join.jpg ”anti_join stopwords with tidy text)
